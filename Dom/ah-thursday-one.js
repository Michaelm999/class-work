...
var newListItem = document.createElement('albumDetails');

// Alright, now let's update the
// text content of that list item.
newListItem.textContent = ["LP"];

// And finally, let's add that list
// item as a child of the ul.
document.getElementByID('albumDetails').formats.appendChild(newListItem);

var relDate = document.getElementsByName('album3').released = 080379;
