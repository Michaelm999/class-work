...
function changeImage() {
	...
	image.addEventListener('click', function() {
		if (image.src == 'https://www.hirerush.com/blog/wp-content/uploads/2016/02/playful-kitten-6683.jpg') {
			console.log('got it');
			image.src = 'http://www.pawderosa.com/images/puppies.jpg'
		} else if (image.src == 'http://www.pawderosa.com/images/puppies.jpg') {
			image.src = 'https://www.hirerush.com/blog/wp-content/uploads/2016/02/playful-kitten-6683.jpg'
		}
	})
}
changeImage();
